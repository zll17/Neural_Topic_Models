...
class DocDataset(Dataset):
    def __init__(self,taskname,txtPath=None,lang="zh",tokenizer=None,stopwords=None,no_below=5,no_above=0.1,rebuild=False,use_tfidf=False):
    ...
    def _tokenize(self, txtPath, lang, stopwords, tokenizer):
        '''
    ...
    def _build_dictionary(self, no_below, no_above):
    ...
    def _convert_to_BOW(self, keep_empty_doc=False):
        '''
    ...
    def _serialize_dictionary(self, tmpDir):
