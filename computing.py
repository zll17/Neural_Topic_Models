...
topics_text = [['肿胀', '贫血', '腹痛', '炎症', '血浆', '血氧', '心律失常', '胰腺', '疫苗'],
        ['贵', '玉米', '牛肉', '刷', '棕色', '苹果', '脏', '涂', '香蕉'],
        ['宝贝', '吹', '姿势', '剪刀', '拼', '妈咪', '题', '唱歌', '打得'],
        ['一团糟', '不在意', '真为', '约会', '放过', '理智', '无意', '滚床单', '实话实说'],
        ["圣诞", '薇薇安', '火鸡', '周二', '生日快乐', '神父', '幸会', '普林斯顿', '呼叫'],
        ['博客', '认知', '共同点', '热情', '舞蹈', '兰', '道夫', '突破', '课程'],
        ['兼', '宗教', '总统', '精子', '道德', '政治', '追求', '吸血鬼', '金钱'],
        ['雪', '挣', '辣妹', '认得', '卡片', '贱人', '宴会', '位子', '手镯'],
        ['面具', '森林', '轮胎', '艘', '广场', '杀掉', '大道', '火箭', '枪声'],
        ['支付', '诈骗', '西亚', '机构', '领事馆', '恐吓', '一次性', '邮箱', '证词']]
